...
var getTasks = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                Items = (_a.sent()).Items;
                return [2 /*return*/, (0, utils_1.response)(200, Items)];
            case 2:
                err_1 = _a.sent();
...
var createTask = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, _a, title, category, description, important, date, task, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                body = event.body;
                _a = JSON.parse(body), title = _a.title, category = _a.category, description = _a.description, important = _a.important, date = _a.date;
            ...
            case 1:
                _b.sent();
                return [2 /*return*/, (0, utils_1.response)(200, task)];
            case 2:
                err_2 = _b.sent();
                return [2 /*return*/, (0, utils_1.response)(500)];
            case 3: return [2 /*return*/];
